...
namespace ConsoleSimulationEngine2000.Tests
{
    public class CharMatrixStackTests
    {
        ...
        public void Test3()
        {
            var cm1 = CharMatrix.Create(" !", 0, 0, 2, 1);
            var cm2 = CharMatrix.Create("? ", 0, 0, 2, 1);
            var cms = new CharMatrixStack(2);
            cms.Add(cm1);
            cms.Add(cm2);
            Assert.AreEqual(cms.x, 0);
        ...
        public void Test4()
        {
            ...
            var cm2 = CharMatrix.Create(" ? ", 0, 0, 3, 1);
            var cms = new CharMatrixStack(2);
            cms.Add(cm1);
            cms.Add(cm2);
            Assert.AreEqual(cms.x, 0);
        ...
        public void Test5()
        {
            ...
            var cm2 = CharMatrix.Create(" ? ".Pastel(Color.Yellow), 0, 0, 3, 1);
            var cms = new CharMatrixStack(2);
            cms.Add(cm1);
            cms.Add(cm2);
            Assert.AreEqual(cms.x, 0);
        ...
        public void Test6()
        {
            ...
            var cm2 = CharMatrix.Create($" ? {Environment.NewLine} ? ".Pastel(Color.Yellow), 0, 0, 3, 2);
            var cms = new CharMatrixStack(2);
            cms.Add(cm1);
            cms.Add(cm2);
            Assert.AreEqual(cms.x, 0);
